...
class _GoogleSignAppState extends State<GoogleSignApp>{
  ...
  Future<FirebaseUser> _signIn(BuildContext context) async{
    ...
    FirebaseUser userDetails= await _firebaseAuth.signInWithCredential(credentials);
    ProviderDetails providerInfo= new ProviderDetails(userDetails.providerId);
    List<ProviderDetails> providerData=new List<ProviderDetails>();
    providerData.add(providerInfo);
    UserDetails details= new UserDetails(userDetails.providerId,
    ...
    new MaterialPageRoute(builder: (context)=> new ProfileScreen(detailsUser: details)),
    );
    return userDetails;
  }
      ...
      body: Builder(builder: (context)=> Stack(
        ...
        children: <Widget>[
          Container(
            ...
            child: Image.network("https://images.pexels.com/photos/799443/pexels-photo-799443.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
            fit: BoxFit.fill,
